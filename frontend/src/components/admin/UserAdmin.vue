            ...
            <b-row>
                <b-col md="6" sm="12">
                    <b-form-group label="Nome:" label-for="user-name">
                        <b-form-input id="user-name" type="text" v-model="user.name" required :readonly="mode === 'remove'"
...
export default {
    ...
    methods: {// salvar, excluir, dar um clean(reset) na tela
        loadUsers() {// Vai ser responsavel por carregar os usuários do backend
